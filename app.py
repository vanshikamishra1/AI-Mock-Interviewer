...
if st.session_state.stage == "interview":
    ...
    if st.session_state.stage == "interview":
        ...
        if st.button("Submit Answer"):
            # User can skip answer; give gentle warning but proceed
            if not user_ans.strip():
                st.session_state.top_message = "You did not provide an answer. Let's move to the next question,this question will be marked as unattempted."
...
if st.session_state.stage == "results":
    ...
    st.info("Your responses have been reviewed. If you qualify, you will receive an email with details for the next steps in the selection process. Stay tuned!")

    st.markdown("---")
    st.markdown(f"**AI Interviewer:** Great job, {st.session_state.name}! Keep practicing and stay confident for your upcoming opportunities.")
